<script type="text/javascript" src="<?php echo base_url(); ?>assets/js/backoffice/master_category.js"></script>
...
<div class="row">
    <div class="col-xs-12">
            <table id="tableCategory" class="table table-striped table-bordered table-hover dt-responsive nowrap" cellspacing="0" width="100%">
                <thead>
                    <tr>
                        <th></th>
                        <th>ID Category</th>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <input type="hidden" id="idCategory"> <!-- categoryId record yg hendak di edit -->
                <form>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="txtCategoryEdit" placeholder="Category Name" onfocusout="cekFormCreateNewCategory('categoryname')">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" id="updateCategory" onclick="updateCategory()">Save changes</button>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade" id="createModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form>
                    <!--<div class="form-group">
                        ...
                        <select class="form-control" id="DrdCategory" name="DrdCategory" onfocusout="cekFormCreateNewItem('category')">
                        </select>
                    ...
                    <div class="form-group">
                        <label for="lblCategoryName">Category Name</label>
                        <input type="text" class="form-control" id="txtCategoryName" placeholder="Category Name" onfocusout="cekFormCreateNewCategory('categoryname')">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                <button type="button" class="btn btn-primary" id="createNewCategory" onclick="createNewCategory()">Save changes</button>
            </div>
        </div>
    </div>
</div>