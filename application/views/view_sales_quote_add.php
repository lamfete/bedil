...
<div class="row" style="margin-bottom:10px;">
    <div class="col-xs-2">
        <label for="lblCustId">Customer ID:</label>
    </div>
    <div class="col-xs-10">
        <input type="text" class="form-control" id="txtCustId" onclick="clearTxtCustId()" autofocus placeholder="Customer ID">
    </div>
</div>
<div class="row" style="margin-bottom:10px;">
    <div class="col-xs-2">
...
<div class="row" style="margin-bottom:10px;">
    <div class="col-xs-12">
    <button type="button" class="btn btn-lg" onclick="addItemToTableItemSales()">
        <span class="glyphicon glyphicon-plus" aria-hidden="true"></span>
        Add Item
    </button>
    </div>
...
<div class="row">
    ...
    <!-- </div>
    <div class="col-xs-12"> -->
        <button type="button" class="btn btn-lg" onclick="window.location.href='/salesquote/manage'">
