<script type="text/javascript" src="<?php echo base_url(); ?>assets/js/backoffice/report_laststock.js"></script>
...
<div class="row">
    <div class="col-xs-12">
        ...
        <table id="tableReportLastStock" class="table table-striped table-bordered table-hover dt-responsive nowrap" cellspacing="0" width="100%">
            <thead>
                <tr>
                    <th></th>
                    <th>Item ID</th>
