<script type="text/javascript" src="<?php echo base_url(); ?>assets/js/backoffice/sales_shipper.js"></script>
...
<div class="row">
    <div class="col-xs-12">
        ...
        <table id="tableSalesShipper" class="table table-striped table-bordered table-hover dt-responsive nowrap" cellspacing="0" width="100%">
            <thead>
                <tr>
                    <th></th>
                    <th>Sales Shipper No</th>
                    <!-- <th>user_level_id</th> -->
                    <th>Sales Shipper Date</th>
                    <th>Customer</th>
                    <th>Kirim Ke</th>
                    <!-- <th>Password</th> -->
                    <!-- <th>Item Name</th> -->
...
<div class="modal fade" id="processModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title" id="lblProcessSalesShipperNo">Process Sales Shipper</h4>
            </div>
            <div class="modal-body">
                <div class="row" style="margin-bottom:10px;">
                    <div class="col-xs-3">
                ...
                <table id="tableProcessSalesShipper" class="table table-striped table-bordered table-hover dt-responsive nowrap" cellspacing="0" width="100%">
                    <thead>
                        <tr>
                            <th width="1%"></th>
                            <th width="2%">ID Item</th>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                <button type="button" class="btn btn-primary" id="btnProceedSalesShipper" onclick="proceedSoToShipper()">Proceed Sales Shipper</button>
            </div>
        </div>
    </div>
</div>